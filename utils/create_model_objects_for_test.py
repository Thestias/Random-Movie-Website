...
def obj_movie_mod_create():
    ...
    Movie.objects.create(movie_id=1, imbd_id='tt0478970', movie_title='Ant-Man', genero='Adventure', original_language='en', overview='''
    ...
    Movie.objects.create(movie_id=2, imbd_id='tt3783958', movie_title='La La Land', genero='Drama', original_language='en', overview='''
